...
/**
 * Removes variable declarations that are never referenced and have no
 * constant violations (i.e. they are truly dead code).
 */
            ...
            Scope(path) {
                for (const binding of Object.values(path.scope.bindings)) {
                    if (
                        ...
                        // Don't remove variables that are exposed globally
                        if (
                        ...
                        for (const path of paths) {
                            // Skip patterns that declare multiple variables
                            if (
